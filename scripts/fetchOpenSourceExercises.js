...
const EXERCISES = [
  "barbell_bench_press", "barbell_incline_bench_press", "dumbbell_bench_press", 
  "dumbbell_incline_bench_press", "decline_bench_press", "close_grip_bench_press", 
  "cable_crossover", "dumbbell_pullover",
  "barbell_bent_over_row", "dumbbell_row", "single_arm_dumbbell_row", 
  "cable_lat_pulldown_wide_grip", "close_grip_pulldown", "pull_up", "chin_up", 
  "seated_cable_row", "t_bar_row", "rack_pull",
  "barbell_back_squat", "front_squat", "goblet_squat", "barbell_deadlift", 
  "romanian_deadlift", "sumo_deadlift", "machine_leg_press", "leg_extension", 
  "lying_leg_curl", "seated_leg_curl", "hip_thrust", "lunge", 
  "bulgarian_split_squat", "standing_calf_raise", "seated_calf_raise", "box_jump",
  "barbell_overhead_press", "dumbbell_shoulder_press", "arnold_press", 
  "dumbbell_lateral_raise", "front_raise", "face_pull", "upright_row", 
  "reverse_pec_deck", "barbell_shrug",
  "barbell_bicep_curl", "alternating_dumbbell_curl", "hammer_curl", 
  "concentration_curl", "preacher_curl", "cable_rope_tricep_pushdown", 
  "skull_crusher", "triceps_pushdown", "overhead_triceps_extension", 
  "diamond_push_up", "bench_dip",
  "plank", "side_plank", "crunch", "cable_crunch", "hanging_leg_raise", 
  "russian_twist", "pallof_press", "lying_leg_raise",
  "push_up", "burpee", "dips", "kettlebell_swing", "power_clean", 
  "jump_squat", "box_step_up",
  "clean_and_jerk", "snatch", "thruster", "farmers_walk", "sled_push", 
  "medicine_ball_slam", "battle_ropes", "sandbag_carry",
  // Bodyweight extras (do bodyweight-exercises.json)
  "bodyweight_squat", "mountain_climbers"
];
...
function generateSvgPlaceholder(exerciseName, muscleGroup) {
  ...
  const emojis = {
    ...
    'Braços': '💪', 'Core': '⭕', 'Full Body': '🏋️', 'Cardio': '🏃',
    'Tríceps': '🦾',
  };
...
const EXERCISE_MUSCLES = {
  barbell_bench_press: 'Peito', barbell_incline_bench_press: 'Peito',
  dumbbell_bench_press: 'Peito', dumbbell_incline_bench_press: 'Peito',
  decline_bench_press: 'Peito', close_grip_bench_press: 'Peito',
  cable_crossover: 'Peito', dumbbell_pullover: 'Peito', push_up: 'Peito',
  barbell_bent_over_row: 'Costas', dumbbell_row: 'Costas',
  single_arm_dumbbell_row: 'Costas', cable_lat_pulldown_wide_grip: 'Costas',
  close_grip_pulldown: 'Costas', pull_up: 'Costas', chin_up: 'Costas',
  seated_cable_row: 'Costas', t_bar_row: 'Costas', rack_pull: 'Costas',
  barbell_back_squat: 'Pernas', front_squat: 'Pernas', goblet_squat: 'Pernas',
  barbell_deadlift: 'Pernas', romanian_deadlift: 'Pernas', sumo_deadlift: 'Pernas',
  machine_leg_press: 'Pernas', leg_extension: 'Pernas', lying_leg_curl: 'Pernas',
  seated_leg_curl: 'Pernas', hip_thrust: 'Pernas', lunge: 'Pernas',
  bulgarian_split_squat: 'Pernas', standing_calf_raise: 'Pernas',
  seated_calf_raise: 'Pernas', box_jump: 'Pernas', jump_squat: 'Pernas',
  box_step_up: 'Pernas', bodyweight_squat: 'Pernas',
  barbell_overhead_press: 'Ombros', dumbbell_shoulder_press: 'Ombros',
  arnold_press: 'Ombros', dumbbell_lateral_raise: 'Ombros', front_raise: 'Ombros',
  face_pull: 'Ombros', upright_row: 'Ombros', reverse_pec_deck: 'Ombros',
  barbell_shrug: 'Ombros',
  barbell_bicep_curl: 'Braços', alternating_dumbbell_curl: 'Braços',
  hammer_curl: 'Braços', concentration_curl: 'Braços', preacher_curl: 'Braços',
  cable_rope_tricep_pushdown: 'Braços', skull_crusher: 'Braços',
  triceps_pushdown: 'Braços', overhead_triceps_extension: 'Braços',
  diamond_push_up: 'Braços', bench_dip: 'Braços',
  plank: 'Core', side_plank: 'Core', crunch: 'Core', cable_crunch: 'Core',
  hanging_leg_raise: 'Core', russian_twist: 'Core', pallof_press: 'Core',
  lying_leg_raise: 'Core',
  burpee: 'Full Body', dips: 'Peito', kettlebell_swing: 'Pernas',
  power_clean: 'Full Body', clean_and_jerk: 'Full Body', snatch: 'Full Body',
  thruster: 'Full Body', farmers_walk: 'Full Body', sled_push: 'Full Body',
  medicine_ball_slam: 'Full Body', battle_ropes: 'Full Body',
  sandbag_carry: 'Full Body', mountain_climbers: 'Cardio',
};
  ...
  for (const slug of EXERCISES) {
    ...
    if (!fs.existsSync(gifPath) || fs.statSync(gifPath).size === 0) {
      ...
      for (const name of possibleNames) {
        ...
        const match = freeDbExercises.find(ex => 
          ex.name && (
