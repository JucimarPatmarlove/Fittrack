...
export const EXERCISE_REGION_MAP: Record<string, ExerciseRegionMapping> = {
  ...
  "Push-Up": {
    ...
    primaryJoints: ["ombro_direito", "ombro_esquerdo", "cotovelo_direito", "cotovelo_esquerdo", "punho_direito", "punho_esquerdo"],
  ...
  "Barbell Bent Over Row": {
    ...
    primaryJoints: ["ombro_direito", "ombro_esquerdo", "coluna_lombar", "cotovelo_direito", "cotovelo_esquerdo"],
    stressMultiplier: 1.3, // Requer muita estabilização lombar
  },
  "Barbell Deadlift": {
    primaryMuscles: ["costas", "gluteos", "isquiotibiais", "core"],
    primaryJoints: ["coluna_lombar", "anca_direita", "anca_esquerda", "joelho_direito", "joelho_esquerdo"],
  ...
  "Barbell Overhead Press": {
    ...
    primaryJoints: ["ombro_direito", "ombro_esquerdo", "cotovelo_direito", "cotovelo_esquerdo", "coluna_cervical"],
  ...
  "Barbell Back Squat": {
    ...
    primaryJoints: ["joelho_direito", "joelho_esquerdo", "anca_direita", "anca_esquerda", "coluna_lombar"],
    stressMultiplier: 1.4,
  },
  "Bodyweight Squat": {
  ...
  "Burpee": {
    ...
    primaryJoints: ["joelho_direito", "joelho_esquerdo", "ombro_direito", "ombro_esquerdo", "tornozelo_direito", "tornozelo_esquerdo"],
    stressMultiplier: 1.3,
  },
  "Running": {
    primaryMuscles: ["cardio", "quadriceps", "isquiotibiais", "panturrilhas"],
    primaryJoints: ["joelho_direito", "joelho_esquerdo", "tornozelo_direito", "tornozelo_esquerdo", "anca_direita", "anca_esquerda"],
    stressMultiplier: 1.2,
  },
};
