...
export const exerciseMediaMap: Record<string, ExerciseMedia> = {
  'Barbell Bench Press': {
    ...
    instructions: 'Mantenha a postura e contraia os músculos do peito. Execute o movimento de forma controlada.',
  ...
  'Barbell Bent Over Row': {
    ...
    instructions: 'Mantenha a postura e contraia os músculos do costas. Execute o movimento de forma controlada.',
    tips: ['Mantenha a respiração estável', 'Foque na fase excêntrica', 'Não compense com outros músculos'],
    muscleGroups: ['Costas']
  },
  'Dumbbell Row': {
  ...
  'Barbell Back Squat': {
    ...
    instructions: 'Mantenha a postura e contraia os músculos do pernas. Execute o movimento de forma controlada.',
    tips: ['Mantenha a respiração estável', 'Foque na fase excêntrica', 'Não compense com outros músculos'],
    muscleGroups: ['Pernas']
  },
  'Front Squat': {
  ...
  'Barbell Overhead Press': {
    ...
    instructions: 'Mantenha a postura e contraia os músculos do ombros. Execute o movimento de forma controlada.',
    tips: ['Mantenha a respiração estável', 'Foque na fase excêntrica', 'Não compense com outros músculos'],
    muscleGroups: ['Ombros']
  },
  ...
  'Barbell Bicep Curl': {
    ...
    instructions: 'Mantenha a postura e contraia os músculos do braços. Execute o movimento de forma controlada.',
    tips: ['Mantenha a respiração estável', 'Foque na fase excêntrica', 'Não compense com outros músculos'],
    muscleGroups: ['Braços']
  },
  ...
  'Plank': {
    ...
    instructions: 'Mantenha a postura e contraia os músculos do core. Execute o movimento de forma controlada.',
    tips: ['Mantenha a respiração estável', 'Foque na fase excêntrica', 'Não compense com outros músculos'],
    muscleGroups: ['Core']
  },
  'Side Plank': {
  ...
  'Burpee': {
    ...
    instructions: 'Mantenha a postura e contraia os músculos do full body. Execute o movimento de forma controlada.',
    tips: ['Mantenha a respiração estável', 'Foque na fase excêntrica', 'Não compense com outros músculos'],
  ...
  'Dips': {
    ...
    instructions: 'Mantenha a postura e contraia os músculos do tríceps. Execute o movimento de forma controlada.',
    tips: ['Mantenha a respiração estável', 'Foque na fase excêntrica', 'Não compense com outros músculos'],
...
export function getExerciseMedia(exerciseName: string): ExerciseMedia {
  ...
  const subMatchKey = Object.keys(SYNONYMS).find(syn => cleanName.includes(syn) || syn.includes(cleanName));
  if (subMatchKey) {
    const mapped = SYNONYMS[subMatchKey];
    const exactMappedKey = Object.keys(exerciseMediaMap).find(k => k.toLowerCase() === mapped.toLowerCase());
