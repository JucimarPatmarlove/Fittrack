          ...
          <>
            <GlassCard style={{ padding: 20 }}>
              ...
              <p style={{ fontSize: 11, color: C.muted, textAlign: 'center', marginTop: 12 }}>
                Readiness elevado + volume moderado = recuperação ótima
              </p>
            </GlassCard>
            ...
            <GlassCard style={{ padding: 20 }}>
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={acwrData}>
                    ...
                    <ReferenceLine
                      ...
                      stroke={C.green}
                      strokeDasharray="3 3"
                      label={{ value: 'Mín. Seguro', fill: C.green, fontSize: 10 }}
                    />
                    <ReferenceLine
                      y={1.3}
                      stroke={C.accent}
                      strokeDasharray="3 3"
                      label={{ value: 'Máx. Seguro', fill: C.accent, fontSize: 10 }}
                    />
              ...
              <p style={{ fontSize: 11, color: C.muted, textAlign: 'center', marginTop: 12 }}>
                ACWR &gt; 1.5 = risco elevado de lesão. Reduza volume imediatamente.
              </p>
            </GlassCard>
            ...
            <GlassCard style={{ padding: 20 }}>
              ...
              <p style={{ fontSize: 11, color: C.muted, textAlign: 'center', marginTop: 12 }}>
                Quanto mais consistente, mais rápido sobes de nível!
              </p>
            </GlassCard>
            ...
            {walkingData.length > 0 && (
              <GlassCard style={{ padding: 20 }}>
                ...
                <p style={{ fontSize: 11, color: C.muted, textAlign: 'center', marginTop: 12 }}>
                  Evolução do teu rendimento nas caminhadas com Radar.
                </p>
              </GlassCard>
            )}
          </>
