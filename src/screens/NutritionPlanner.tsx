...
import { FitnessGoal, ActivityLevel } from "../services/nutritionEngine";
export type AIChatMessage = { id: string; sender: "user" | "ai"; text: string; timestamp: string; };
import { PRESET_FOODS, calculateMacros, translateGoal, translateActivityLevel } from "../services/nutritionEngine";
  ...
  return (
    <div id="nutrition-planner-view" className="space-y-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="xl:col-span-1 glass rounded-3xl shadow-xs border border-gray-100 p-6" id="bmr-calc-container">
          ...
          <form onSubmit={handleCalculateMetabolism} className="space-y-4">
            <div className="grid grid-cols-3 gap-3">
              <div className="space-y-1">
                ...
                <input 
                  ...
                  className="w-full bg-slate-50 border border-gray-200 rounded-lg py-1.5 px-2.5 text-xs text-gray-800 font-bold focus:outline-hidden focus:border-[#00ff88]"
                />
              </div>
              <div className="space-y-1">
            ...
            <button 
              ...
              className="w-full py-2.5 px-3 bg-[#00ff88] hover:bg-[#00cc66] text-white font-extrabold text-xs uppercase tracking-wider rounded-xl transition-colors cursor-pointer flex items-center justify-center gap-1 shadow-sm"
            >
          ...
          {isCalculated && tempProfile && (
            <div className="mt-5 p-4 bg-emerald-50 border border-emerald-250 rounded-2xl space-y-3 shadow-2xs">
              <div className="flex items-center justify-between">
                ...
                <span className="text-2xs font-extrabold text-[#00ff88] uppercase tracking-widest glass border border-emerald-100 py-0.5 px-2 rounded-md">Pronto</span>
              </div>
              
              <div className="grid grid-cols-2 gap-2 text-center text-gray-800">
                <div className="glass p-2 border border-emerald-100 rounded-lg">
                ...
                <div className="glass p-2 border border-emerald-100 rounded-lg">
                  <div className="text-lg font-black text-[#00cc66]">{tempProfile.targetProtein}g</div>
                ...
                <div className="glass p-2 border border-emerald-100 rounded-lg">
                  <div className="text-lg font-black text-[#ccff00]">{tempProfile.targetFat}g</div>
              ...
              <button 
                ...
                className="w-full py-2 bg-[#00cc66] hover:bg-emerald-700 text-white text-xs font-extrabold uppercase tracking-wider rounded-xl transition-colors cursor-pointer flex items-center justify-center gap-1.5"
              >
        ...
        <div className="xl:col-span-2 bg-slate-900 text-white rounded-3xl p-6 flex flex-col justify-between" id="diet-meta-summary bg">
          <div>
            <div className="flex items-center justify-between">
              <span className="text-[#00ff88] font-black text-3xs uppercase tracking-widest">Dashboard Nutricional</span>
              <Apple className="w-5 h-5 text-[#00ff88] animate-pulse" />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
              ...
              <div className="space-y-1 border-r border-slate-800 pr-4">
                ...
                <div className="text-3l mt-1 font-extrabold text-[#00ff88]">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-slate-950/65 p-3 rounded-xl border border-slate-850">
                    ...
                    <div className={`text-lg font-bold ${profile.targetCalories - totalCaloriesLogged >= 0 ? "text-[#00ff88]" : "text-rose-400"}`}>
                ...
                <div className="flex gap-4 text-xs font-semibold text-slate-300">
                  <span>P: <span className="text-[#00ff88]">{totalProteinLogged}g</span> / {profile.targetProtein}g</span>
                  <span>C: <span className="text-blue-400">{totalCarbLogged}g</span> / {profile.targetCarb}g</span>
                  <span>G: <span className="text-[#ccff00]">{totalFatLogged}g</span> / {profile.targetFat}g</span>
                </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
        ...
        <div className="xl:col-span-7 glass rounded-3xl border border-gray-100 shadow-xs p-6" id="meals-logger-wrapper">
          <div className="flex items-end justify-between border-b border-gray-100 pb-4 mb-4">
            <div>
              <h3 className="font-extrabold text-gray-900 text-lg flex items-center gap-1.5">
                <Utensils className="w-5 h-5 text-[#00ff88]" />
                Alimentação Diária
              </h3>
              ...
              return (
                <button
                  ...
                  className={`py-2 text-xs font-extrabold uppercase tracking-wide rounded-lg transition-all cursor-pointer ${
                    activeSegment === seg 
                      ? "glass text-[#00cc66] shadow-2xs" 
                      : "text-gray-500 hover:text-gray-900"
                  }`}
                >
                  {names[seg]}
                  {count > 0 && <span className="ml-1 text-4xs bg-[#00ff88] text-white py-0.5 px-1.5 rounded-full">{count}</span>}
                </button>
              );
            })}
          </div>
          ...
          <form onSubmit={handleLogMealItem} className="bg-slate-50 p-4 rounded-2xl mb-6 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-1">
                ...
                <select 
                  ...
                  className="w-full glass border border-gray-200 rounded-lg text-sm px-3 py-1.5 text-gray-700 font-semibold focus:outline-hidden"
                >
              ...
              {presetFoodIndex === "custom" && (
                <div className="space-y-1">
                  ...
                  <input 
                    ...
                    className="w-full glass border border-gray-200 rounded-lg text-sm px-3 py-1.5 text-gray-800"
                  />
                </div>
              )}
            ...
            <div className="grid grid-cols-4 gap-2 text-center">
              <div>
                ...
                <div className="relative">
                  <input 
                    ...
                    className="w-full glass border border-gray-200 rounded-lg text-center font-bold text-xs py-1"
                  />
              ...
              <div>
                <label className="text-4xs font-bold text-[#00cc66] uppercase tracking-wider block mb-1">Proteína</label>
                <div className="relative">
                  <input 
                    type="number" 
                    id="food-protein"
              ...
              <div>
                <label className="text-4xs font-bold text-[#ccff00] uppercase tracking-wider block mb-1">Gorduras</label>
                <div className="relative">
                  <input 
                    type="number" 
                    id="food-fat"
            ...
            <button 
              type="submit"
              id="log-food-button"
              className="w-full py-2 bg-[#00ff88] hover:bg-[#00cc66] font-black text-xs uppercase tracking-wider text-white rounded-xl transition-colors cursor-pointer flex items-center justify-center gap-1.5"
            >
          ...
          <div className="space-y-3" id="active-segment-items-list">
                ...
                {todayMeals[activeSegment].map((item) => (
                  <div key={item.id} className="py-2.5 flex items-center justify-between hover:bg-slate-50 px-1 rounded-sm">
                    ...
                    <div className="flex items-center gap-4 text-xs">
                      ...
                      <span className="font-extrabold text-[#00cc66] text-xs text-right min-w-[50px]">
                        {item.calories} kcal
                      </span>
                      <button 
            ...
            {todayMeals[activeSegment].length > 0 && (
              <div className="bg-slate-50 rounded-xl p-3 mt-4 text-xs font-semibold text-gray-600 flex items-center justify-between">
                ...
                <span className="text-gray-900 font-bold glass border border-slate-200 py-1 px-3 rounded-lg shadow-3xs">
        ...
        <div className="xl:col-span-5 bg-slate-900 rounded-3xl border border-slate-800 flex flex-col h-[600px] overflow-hidden" id="ai-chef-chat">
          ...
          <div className="p-4 bg-slate-950 border-b border-slate-850 flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <div className="w-10 h-10 rounded-full bg-[#00ff88]/10 flex items-center justify-center border border-[#00ff88]/25">
              ...
              <div>
                <h4 className="text-sm font-extrabold text-white tracking-widest flex items-center gap-1">
                  NutriChef AI
                  <Sparkle className="w-3.5 h-3.5 text-[#00ff88] animate-spin-slow" />
                </h4>
                <span className="text-3xs text-[#00ff88] font-bold block">Consulente de Receitas e Nutrologia</span>
              </div>
            </div>
              ...
              >
                <div 
                  className={`max-w-[85%] rounded-2xl p-4 shadow-2xs ${
                    msg.sender === "user" 
                      ? "bg-[#00cc66] text-white rounded-br-none" 
                      : "bg-slate-800 text-slate-100 rounded-bl-none border border-slate-700/50"
                  }`}
                >
                  <div className="text-xs leading-relaxed max-w-none whitespace-pre-wrap">
                    {msg.text}
                  </div>
              ...
              <div className="flex justify-start">
                <div className="bg-slate-800 border border-slate-700 p-4 rounded-2xl rounded-bl-none flex items-center gap-3">
                  <div className="flex space-x-1.5">
                    ...
                    <div className="w-2.5 h-2.5 bg-[#00ff88] rounded-full animate-bounce [animation-delay:0.2s]" />
                    <div className="w-2.5 h-2.5 bg-[#00ff88] rounded-full animate-bounce [animation-delay:0.4s]" />
                  </div>
          ...
          >
            <input 
              ...
              className="flex-1 bg-slate-900 border border-slate-800 rounded-xl px-4 py-2.5 text-xs text-white placeholder-slate-500 font-medium focus:outline-hidden focus:ring-1 focus:ring-[#00ff88] focus:border-[#00ff88] disabled:opacity-50"
            />
            <button 
              type="submit"
              id="send-chef-prompt"
              disabled={isAiLoading || !userQuery.trim()}
              className="p-2.5 bg-[#00ff88] hover:bg-[#00cc66] text-white rounded-xl transition-colors cursor-pointer flex items-center justify-center shrink-0 disabled:opacity-50"
