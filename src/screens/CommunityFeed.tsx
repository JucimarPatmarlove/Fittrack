...
import { Activity, Flame, Heart, MapPin, MessageSquare } from 'lucide-react';
// @ts-nocheck
      ...
      >
        <div>
          ...
          <p style={{ margin: 0, color: C.muted, fontSize: 14 }}>
            O teu feed de atividades global.
          </p>
        </div>
        <div
          style={{
        ...
        {feed.map((post) => {
          ...
          return (
            ...
            >
              ...
              <div>
                <h3
                  style={{ margin: '0 0 12px 0', fontSize: 20, fontWeight: 'bold', color: '#fff' }}
                >
                  {post.workoutName}
                </h3>
                ...
                <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
                  {post.durationMinutes > 0 && (
                    <div style={{ display: 'flex', flexDirection: 'column' }}>
                      ...
                      <span style={{ fontSize: 18, color: '#fff', fontWeight: 'bold' }}>
                  ...
                  {post.metrics.distanceKm && (
                    ...
                    >
                      ...
                      <span style={{ fontSize: 18, color: '#fff', fontWeight: 'bold' }}>
                        {post.metrics.distanceKm.toFixed(2)} km
                      </span>
                    </div>
                  )}
                  {post.metrics.pace && (
                    ...
                    >
                      ...
                      <span style={{ fontSize: 18, color: '#fff', fontWeight: 'bold' }}>
                        {post.metrics.pace.toFixed(2)} /km
                      </span>
                    </div>
                  )}
                  {post.metrics.volume && (
              ...
              >
                {post.isWalkingCoach ? (
                  <>
                    ...
                    >
                      <polyline
                        points="10,80 30,50 60,70 90,20"
                        fill="none"
                        stroke={C.accent}
                        strokeWidth="2"
                        strokeLinecap="round"
                  ...
                  <>
                    <div
                      style={{
                        position: 'absolute',
                        inset: 0,
                        background: `linear-gradient(45deg, ${C.surface}, #1e2532)`,
                      }}
                    />
                    ...
                    >
                      ...
                      <span style={{ fontSize: 10, color: '#fff' }}>
                        {post.metrics.calories || 300} kcal Queimadas
                      </span>
                    </div>
                  </>
                )}
              ...
              >
                <button
                  ...
                  style={{
                    ...
                    background: 'none',
                    border: 'none',
                    color: post.hasGivenKudos ? '#ff3366' : C.text,
                    cursor: 'pointer',
                    fontWeight: 'bold',
                  }}
                >
                  <motion.div whileTap={{ scale: 1.5 }}>
                    <Heart
                      size={20}
                      fill={post.hasGivenKudos ? '#ff3366' : 'none'}
                      color={post.hasGivenKudos ? '#ff3366' : C.muted}
                    />
                  </motion.div>
                  ...
                  >
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginTop: 8 }}>
                      {post.comments.map((comment, i) => (
                        ...
                        >
                          <span style={{ fontWeight: 'bold', color: C.accent, marginRight: 8 }}>
                            {comment.user}
                          </span>
