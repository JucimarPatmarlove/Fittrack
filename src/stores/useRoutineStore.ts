    ...
    days: [
      {
        ...
        focus: 'Push',
        exercises: ['Supino Inclinado com Halteres', 'Desenvolvimento', 'Tríceps Corda'],
      },
      {
        label: 'Pull (Costas, Bíceps)',
        focus: 'Pull',
        exercises: ['Puxada Frontal', 'Remada Curvada', 'Rosca Direta'],
      },
      {
        label: 'Pernas',
        focus: 'Legs',
        exercises: ['Agachamento Livre', 'Leg Press', 'Cadeira Extensora'],
      },
      {
        label: 'Full Body',
        focus: 'Full Body',
        exercises: ['Desenvolvimento', 'Agachamento Livre', 'Puxada Frontal', 'Abdominais'],
      },
    ],
  },
  {
    ...
    days: [
      {
        ...
        focus: 'Upper',
        exercises: ['Supino Reto', 'Remada Curvada', 'Desenvolvimento'],
      },
      {
        label: 'Força Inferior',
        focus: 'Lower',
        exercises: ['Agachamento Livre', 'Levantamento Terra', 'Leg Press'],
      },
      {
        label: 'Potência Total',
        focus: 'Full',
        exercises: ['Levantamento Terra', 'Supino Inclinado com Halteres'],
      },
    ],
  },
];
  ...
  persist(
    (set, get) => ({
      ...
      getActiveRoutine: () => {
        ...
        return (
          get().customRoutines.find((r) => r.id === id) ||
          DEFAULT_ROUTINES.find((r) => r.id === id) ||
          null
        );
      },
