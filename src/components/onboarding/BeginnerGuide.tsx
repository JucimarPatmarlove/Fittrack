...
export const BeginnerGuide = ({ onComplete }: { onComplete: () => void }) => {
    ...
    const guides = [
        ...
        },
        {
            ...
            content: (
                <div>
                    <p><strong>Regra de ouro para iniciantes:</strong></p>
                    ...
                    <div style={{ background: '#e8c84a22', color: '#e8c84a', padding: 12, borderRadius: 8, marginTop: 12, fontSize: 14 }}>
    ...
    return (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: '#080b0f', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
            <div style={{ maxWidth: 400, textAlign: 'center' }}>
                ...
                <h2 style={{ color: '#e8c84a', marginBottom: 20 }}>
                    {guides[step].title}
                </h2>
                ...
                <div style={{ display: 'flex', gap: 10 }}>
                    {step > 0 && (
                        <button
                            ...
                            style={{ flex: 1, background: 'transparent', border: '1px solid #1e2832', borderRadius: 8, padding: 12, color: '#55626e', cursor: 'pointer' }}
                        >
                            Voltar
                        </button>
                    )}
                    <button
                        ...
                        style={{ flex: 1, background: '#e8c84a', border: 'none', borderRadius: 8, padding: 12, color: '#000', fontWeight: 700, cursor: 'pointer' }}
                    >
