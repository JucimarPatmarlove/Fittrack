...
export const WelcomeWizard: React.FC<WelcomeWizardProps> = ({ onComplete, profile, setProfile, onClearMocks }) => {
  ...
  return (
    <div style={{
      ...
      background: C.bg, zIndex: 9999, display: 'flex', flexDirection: 'column',
      ...
      <AnimatePresence mode="wait">
        {step === 1 && (
          ...
          >
            <h1 style={{ fontFamily: "'Bebas Neue'", fontSize: 36, color: C.accent, letterSpacing: 2 }}>BEM-VINDO AO FITTRACK V7</h1>
            <p style={{ color: C.muted, fontSize: 14, marginBottom: 30 }}>Qual é o teu objetivo principal?</p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 30 }}>
              {[
                ...
                <button
                  ...
                  style={{
                    background: selectedGoal === g.id ? 'rgba(232, 200, 74, 0.1)' : 'rgba(255,255,255,0.05)',
                    border: `1px solid ${selectedGoal === g.id ? C.accent : 'rgba(255,255,255,0.1)'}`,
                    color: selectedGoal === g.id ? C.accent : C.text,
                    padding: 16, borderRadius: 12, fontSize: 16, cursor: 'pointer',
            ...
            <button
              onClick={nextStep}
              style={{
                width: '100%', background: C.accent, color: '#000', border: 'none', padding: 16,
                borderRadius: 12, fontFamily: "'Bebas Neue'", fontSize: 20, cursor: 'pointer'
              }}
            >
              CONTINUAR
            </button>
        ...
        {step === 2 && (
          ...
          >
            ...
            <h2 style={{ fontFamily: "'Bebas Neue'", fontSize: 32, color: C.accent, letterSpacing: 2 }}>MODO DE DEMONSTRAÇÃO</h2>
            <p style={{ color: C.muted, fontSize: 14, marginBottom: 20, lineHeight: 1.5 }}>
              Atualmente, o teu painel pode conter <strong>dados simulados</strong> (workouts gerados automaticamente) para demonstração dos gráficos e Inteligência Artificial.
            </p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              <button
                onClick={handlePurge}
                style={{
                  width: '100%', background: 'transparent', color: '#ff4444', border: '1px solid #ff4444', padding: 16,
                  borderRadius: 12, fontFamily: "'Bebas Neue'", fontSize: 18, cursor: 'pointer', letterSpacing: 1
                }}
              >
              ...
              <button
                onClick={nextStep}
                style={{
                  width: '100%', background: 'rgba(255,255,255,0.05)', color: C.text, border: 'none', padding: 16,
          ...
          >
            ...
            <form onSubmit={handleFinalize}>
              <input
                ...
                autoFocus
                style={{
                  width: '100%', background: 'rgba(0,0,0,0.3)', border: `2px solid ${error ? '#ff4444' : C.accent}`,
                  borderRadius: 12, padding: 16, color: C.text, fontSize: 24, textAlign: 'center',
              ...
              <button
                ...
                style={{
                  width: '100%', background: C.accent, color: '#000', border: 'none', padding: 16,
                  borderRadius: 12, fontFamily: "'Bebas Neue'", fontSize: 20, cursor: loading || pin.length < 4 ? 'not-allowed' : 'pointer',
                  opacity: loading || pin.length < 4 ? 0.5 : 1, letterSpacing: 2
                }}
              >
