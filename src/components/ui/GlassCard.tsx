  ...
  return (
    <motion.div
      ...
      style={{
        ...
        border: glow ? '1px solid rgba(232, 200, 74, 0.25)' : '1px solid rgba(232, 200, 74, 0.08)',
        boxShadow: glow
    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          pointerEvents: 'none',
          background:
            'linear-gradient(135deg, rgba(232,200,74,0.12) 0%, transparent 50%, rgba(232,200,74,0.06) 100%)',
        }}
      />
