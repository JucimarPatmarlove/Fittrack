...
import { Calendar, CheckCircle, Circle, Flame, Target, Trophy } from 'lucide-react';
...
export const Challenge90Days = () => {
  ...
  if (!startDate) {
    return (
      ...
      >
        ...
        <h3
          style={{ fontSize: 24, fontFamily: "'Bebas Neue'", color: C.accent, margin: '0 0 8px 0' }}
        >
          DESAFIO 90 DIAS
        </h3>
        <p style={{ color: C.muted, fontSize: 13, marginBottom: 24 }}>
          Transforme seus hábitos com checklists diários de refeições.
        </p>
        <button
  ...
  return (
    ...
    >
      <div
        style={{ background: `linear-gradient(to right, ${C.accent}33, transparent)`, padding: 16 }}
      >
        <div
          style={{
            display: 'flex',
        ...
        >
          <h3 style={{ fontSize: 24, fontFamily: "'Bebas Neue'", color: C.accent, margin: 0 }}>
            🔥 DESAFIO 90 DIAS
          </h3>
        ...
        >
          <span style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
            <Flame size={14} color="#f97316" /> {currentStreak} dias
          </span>
          <span style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
            <Target size={14} color={C.accent} /> {Math.floor(completionRate)}%
          </span>
          <span style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
            <Calendar size={14} color="#3b82f6" /> Faltam {daysRemaining}
          </span>
        </div>
      </div>
