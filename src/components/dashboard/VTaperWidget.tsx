  ...
  return (
    <GlassCard glow style={{ padding: 16, marginBottom: 20, borderLeft: `4px solid ${C.accent}` }}>
      ...
      <p style={{ fontSize: 13, color: '#e0e0e0', lineHeight: 1.4, margin: 0 }}>
        Foco em <strong style={{ color: '#ccff00' }}>largura de ombros</strong> e{' '}
        <strong style={{ color: '#00d4ff' }}>dorsais</strong>. Evita hipertrofia de oblíquos.
      </p>
      <div
        style={{
          marginTop: 12,
      ...
      >
        <p style={{ fontSize: 11, color: C.muted, marginBottom: 2, fontWeight: 'bold' }}>
          📐 RÁCIO RECOMENDADO
        </p>
        <p style={{ fontSize: 12, fontFamily: 'monospace', color: '#fff', margin: 0 }}>
          Elevações laterais + Puxadas | 3:1 vs peito
        </p>
      </div>
      <button
        onClick={() => {
