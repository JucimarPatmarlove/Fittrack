...
import { Activity, Moon, Scale, Zap } from 'lucide-react';
// @ts-nocheck
import type React from 'react';
import type { HealthKitData } from '../../services/healthKitService';
import type { DailyAdjustment } from '../../utils/dailyAdjustment';
      ...
      >
        ...
        >
          ...
          >
            ...
            <span
              style={{ fontSize: '0.875rem', color: 'rgba(255,255,255,0.5)', marginLeft: '4px' }}
            >
              kg
            </span>
          </p>
        ...
        {adjustment.sleepInsight && (
          <p
            style={{
              ...
              paddingTop: '4px',
              margin: 0,
              background: 'linear-gradient(90deg, rgba(255,170,0,0.1) 0%, rgba(255,170,0,0) 100%)',
            }}
          >
            {adjustment.sleepInsight}
          </p>
      ...
      >
        ...
        <div style={{ textAlign: 'right' }}>
          ...
          >
            ...
            <span style={{ fontSize: '0.75rem', color: 'rgba(255,255,255,0.5)' }}>kcal</span>
          </p>
        </div>
      </div>
    </motion.div>
