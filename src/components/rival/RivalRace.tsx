...
import { RivalAI, type RivalState } from '../../services/rivalAI';

export const RivalRace = ({
  rivalState,
  elapsed,
  currentVolume,
}: { rivalState: RivalState; elapsed: number; currentVolume: number }) => {
  ...
  return (
    <div
      style={{
        background: C.card,
        border: `1px solid ${isWinning ? C.green : C.red}`,
        borderRadius: 12,
        padding: 12,
        marginBottom: 16,
      }}
      ...
      >
        <motion.div
          ...
          style={{
            ...
            left: 0,
            height: '100%',
            background: isWinning ? C.green : C.accent,
            borderRadius: 14,
          }}
        />
        <span
