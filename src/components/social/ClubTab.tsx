...
export const ClubTab = () => {
  const { myClub, createClub, joinClub, leaveClub, submitXP, clubLoading, clubError } =
    useSocialStore();
    ...
    <div>
      {!myClub ? (
        ...
        <>
          ...
          >
            <div>
              <p style={{ fontFamily: "'Bebas Neue'", fontSize: 20, color: '#fff', margin: 0 }}>
                {myClub.name}
              </p>
              <p style={{ fontFamily: "'DM Mono'", fontSize: 11, color: C.muted, margin: 0 }}>
                Código: {myClub.code}
              </p>
            </div>
            ...
            {myClub.members
              ...
              .map((m) => (
                ...
                >
                  ...
                  <span style={{ fontFamily: "'DM Mono'", color: C.accent }}>
                    {m.xpThisWeek} XP
                  </span>
                </div>
              ))}
            ...
            >
              <div
                style={{
                  height: '100%',
                  background: C.accent,
                  width: `${Math.min(100, (myClub.weeklyProgress / myClub.weeklyGoal) * 100)}%`,
                }}
              />
            </div>
