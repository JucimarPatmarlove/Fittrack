...
import { WebRTCEngine, type WebRTCMessage } from '../../services/webrtcEngine';
...
export const P2PSyncModal: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  const handlePushLatestWorkout = async () => {
    try {
      ...
      const latestWorkout = history.sort(
      ...
      >
        ...
        >
          <div
            style={{
              ...
              borderRadius: '50%',
              background:
                status === 'connected' ? '#00ff88' : status === 'failed' ? '#ff3366' : '#ccff00',
              boxShadow: `0 0 10px ${status === 'connected' ? '#00ff88' : '#ccff00'}`,
            }}
          />
          <span
            style={{
        ...
        {mode === 'IDLE' && (
          <div style={{ display: 'grid', gap: '16px' }}>
            <button
              ...
              style={{
                background: 'linear-gradient(135deg, #ccff00, #a8e000)',
                color: '#000',
                padding: '16px',
                borderRadius: '12px',
                border: 'none',
        ...
        {mode === 'HOST' && (
          ...
          >
            ...
            >
              Pede ao Guest para ler este código:
            </p>
          ...
          >
            {!token ? (
              <>
                ...
                >
                  Aponta a câmara para o código do Host:
                </p>
                <div
                  style={{
                    width: '100%',
              ...
              <>
                ...
                >
                  Resposta gerada. Mostra ou envia isto ao Host:
                </p>
                <div
                  style={{
                    padding: '16px',
