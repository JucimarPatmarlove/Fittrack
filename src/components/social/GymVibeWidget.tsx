      ...
      {activeCount > 0 && (
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <div>
              <span style={{ display: 'block', fontSize: 13, fontWeight: 'bold', color: C.accent }}>
                {activeCount} pessoa{activeCount !== 1 ? 's' : ''} a treinar agora
              </span>
              <span style={{ display: 'block', fontSize: 11, color: '#fff' }}>
                Ouve a música do ginásio!
              </span>
            </div>
          </div>
