    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', gap: 12 }}>
          ...
          <div
            ...
            onClick={convertEffortToTokens}
            title="Convert to $FIT Tokens"
          >
      ...
      {!isLogged ? (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
              <label style={{ fontSize: 14, color: C.text }}>
                Rate of Perceived Exertion (RPE)
              </label>
              <span style={{ fontSize: 16, fontWeight: 'bold', color: getRpeColor(rpe) }}>
                {rpe}/10
              </span>
            </div>
            <input
          ...
          >
            <div>
              <p style={{ fontSize: 12, color: C.muted, margin: '0 0 4px 0' }}>
                Est. Points Earned
              </p>
              <p style={{ fontSize: 22, fontWeight: 'bold', color: C.accent, margin: 0 }}>
                +{rpe * workoutDurationMinutes}
              </p>
            </div>
            <button
        ...
        <div style={{ textAlign: 'center', padding: '24px 0' }}>
          ...
          <h4 style={{ fontSize: 18, fontWeight: 'bold', color: '#fff', margin: '0 0 8px 0' }}>
            Effort Logged!
          </h4>
          <p style={{ color: C.muted, fontSize: 14, margin: 0 }}>
            You earned {rpe * workoutDurationMinutes} points. Keep pushing!
          </p>
        </div>
      )}
    </div>
