import { FitnessGoal, ActivityLevel, UserProfile, MealItem } from "./types";
...
// Today formatting helper YYYY-MM-DD
...
export function playAlertBeep(frequency = 587.33, duration = 0.15, count = 2) {
  try {
    ...
    for (let i = 0; i < count; i++) {
      ...
      time += duration + 0.08; // gap between individual beeps
    }
  } catch (err) {
...
// Preset simulated technical fitness/nutrition values
